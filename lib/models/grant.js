...
var _default = provider => class Grant extends (0, _apply.default)([(0, _has_format.default)(provider, 'Grant', provider.BaseToken)]) {
  static get IN_PAYLOAD() {
    return ['accountId', 'clientId', 'resources', 'openid', 'rejected', ...super.IN_PAYLOAD];
  }
  clean() {
    if (this.openid && !this.openid.scope && (!this.openid.claims || this.openid.claims.length === 0)) {
      delete this.openid;
    }
    if (this.resources) {
