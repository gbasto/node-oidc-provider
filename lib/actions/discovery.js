...
var _defaults = _interopRequireDefault(require("../helpers/_/defaults.js"));
var _weak_cache = _interopRequireDefault(require("../helpers/weak_cache.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/* eslint-disable max-len */

function discovery(ctx, next) {
  const config = (0, _weak_cache.default)(ctx.oidc.provider).configuration();
  const {
    features
  } = config;
  ctx.body = {
  ...
  (0, _defaults.default)(ctx.body, config.discovery);
  return next();
}